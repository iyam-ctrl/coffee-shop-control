...
type Movement = { id: string; ingredient_id: string; movement_type: string; quantity: number; unit_cost: number; note: string | null; created_at: string; ingredients?: any };
...
const input = { width: "100%", padding: "11px 12px", borderRadius: 10, border: "1px solid #343a42", background: "#0f1215", color: "#f5f1e8", outline: "none" } as const;
const button = { padding: "11px 15px", borderRadius: 10, border: "1px solid #343a42", background: "#171b20", color: "#f5f1e8", cursor: "pointer" } as const;
const primary = { padding: "11px 15px", borderRadius: 10, border: "1px solid #9c7a3d", background: "#8c6a2f", color: "#fff8e8", cursor: "pointer" } as const;
const notice = { padding: "12px 14px", borderRadius: 10, background: "#111419", border: "1px solid #292e34", marginBottom: 14 } as const;
const tabs = { display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 18 } as const;
const tabButton = { ...button, background: "#111419" } as const;
const activeTab = { ...button, background: "#8c6a2f", borderColor: "#b18a49" } as const;
const formGrid = { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(220px,1fr))", gap: 12, marginTop: 18 } as const;
const table = { width: "100%", borderCollapse: "collapse" as const };
const th = { textAlign: "left" as const, padding: "11px 10px", borderBottom: "1px solid #30353c", color: "#9299a3", fontSize: 12 };
const td = { padding: "12px 10px", borderBottom: "1px solid #242930", fontSize: 13 };
const badge = { display: "inline-block", padding: "5px 8px", borderRadius: 999, border: "1px solid", background: "#111419", fontSize: 11 } as const;
const activity = { display: "flex", justifyContent: "space-between", gap: 12, padding: "13px 0", borderBottom: "1px solid #242930" } as const;
